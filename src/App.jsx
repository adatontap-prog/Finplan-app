                  ...
                  return (
                    <div key={h.id} style={{ padding: "12px 14px", marginBottom: "8px", borderRadius: "12px", background: "rgba(255,255,255,0.05)" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
                        <div><div style={{ fontSize: "13px", fontWeight: 600 }}>{at ? at.icon : ""} {h.ticker || (at ? at.label : "")}</div><div style={{ fontSize: "11px", color: "#555" }}>{h.qty} {(at ? at.unit : "")} ? beli {formatRupiah(h.buyPrice)}/{(at ? at.unit : "")}</div></div>
